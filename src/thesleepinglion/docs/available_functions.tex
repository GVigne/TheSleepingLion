...
\begin{minipage}{0.45\linewidth}
\raggedleft
\includegraphics[scale=0.5]{Doc_generation/Aliases_images/regenerate.pdf}
\end{minipage}
\begin{center}
\begin{BVerbatim}
\regenerate = REGENERATE \image{regenerate.svg}
\end{BVerbatim}
\end{center}
...
\begin{minipage}{0.45\linewidth}
\raggedleft
\includegraphics[scale=0.5]{Doc_generation/Aliases_images/ward.pdf}
\end{minipage}
\begin{center}
\begin{BVerbatim}
\ward = WARD \image{ward.svg}
\end{BVerbatim}
\end{center}

\subsubsection{brittle}
\begin{minipage}{0.45\linewidth}
\raggedright
\begin{spverbatim}
\brittle
...
\begin{minipage}{0.45\linewidth}
\raggedleft
\includegraphics[scale=0.5]{Doc_generation/Aliases_images/brittle.pdf}
\end{minipage}
\begin{center}
\begin{BVerbatim}
\brittle = BRITTLE \image{brittle.svg}
\end{BVerbatim}
\end{center}
...
\begin{minipage}{0.45\linewidth}
\raggedleft
\includegraphics[scale=0.5]{Doc_generation/Aliases_images/bane.pdf}
\end{minipage}
\begin{center}
\begin{BVerbatim}
\bane = BANE \image{bane.svg}
\end{BVerbatim}
\end{center}
