...
class GloomhavenLineContext(AbstractGMLLineContext):
    ...
    """
    @staticmethod
    def CreateFromIndentation(is_small_context: bool, class_color: dict):
        """
        ...
        return GloomhavenLineContext(font_size = font_size, is_small_context=is_small_context, class_color=class_color)

    def __init__(self,
                font: int = card_font,
                font_size: int = base_font_size,
                is_small_context: bool = False,
                bold: bool = False,
        ...
        super().__init__(font, font_size, is_small_context, bold, text_color, class_color, Haven.GLOOMHAVEN)
    ...
    def new_context_effects(self,
        ...
        last_context = GloomhavenLineContext(self.font, self.font_size, self.is_small_context,
